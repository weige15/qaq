...
- Full Llama router training still requires a GPU-backed teacher/student forward run. The current visible GPU is a 6 GiB RTX 4050 and the trainer preflight reports at least 30.42 GiB free is needed for the current separate teacher+student BF16 weight-loading path before activations.
